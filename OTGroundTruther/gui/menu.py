...
class FileMenu(Menu):
    ...
    def _get_and_place_widgets(self) -> None:
        ...
        self.add_command(label="Load otevent", command=self._presenter.load_otevent)
        self.add_command(label="Safe Events as otevent",
                         command=self._presenter.safe_otevents)
