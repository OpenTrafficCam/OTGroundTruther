...
class FrameCanvas(ctk.CTkFrame):
    ...
    def introduce_to_viewmodel(self) -> None:
        self._presenter.set_frame_canvas(self)

    def _get_widgets(self) -> None:
        self.canvas_background = CanvasBackground(
            master=self, viewmodel=self._presenter
        )
    ...
    def update_background(self, image: Image) -> None:
        photo_image = ImageTk.PhotoImage(image=image.as_image())
        self.add_image(DisplayableImage(photo_image), layer="background")
